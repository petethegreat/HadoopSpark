...
#### Correcting the HTML
The script below cleans and parses our initial html, and prints the keywords 
...
The following script dumps all the keywords out to a text file. I'm interested in keywords by class and level, so construct a key from this information.
